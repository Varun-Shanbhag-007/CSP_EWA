...
public class Utilities extends HttpServlet {
	...
	public void printHtml(String file) {
		...
		if(file=="Header.html")
		{
			...
			{
				result = result+"<li><a href='Logout'><span class='glyphicon glyphicon-log-in'></span> &nbspHello,"+session.getAttribute("username").toString()+"</a></li>";
			}
			else
			{
				result = result+"<li><a href='Login'><span class='glyphicon glyphicon-log-out'></span>Login</a></li>";
			}
			pw.println(result);
		}
		else
