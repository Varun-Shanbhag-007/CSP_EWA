...
@WebServlet("/MusicProducts")

public class MusicProducts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Reader reader = new FileReader(TOMCAT_HOME + "\\webapps\\Project\\Data\\music_proc.json");
		...
		try {
			...
			// Convert JSON array to Object and store it in local object every time this servlet is run
		...
		// Customized Recommendation for User
		if (prodRecmMap.containsKey(utility.username())) {
			...
			// Display all the top recommended products
		...
		//Display all the Top products which are generated dynamically from JSON FILE
		...
		utility.printHtml("RightNavigationBarMusic.html");
